                                        ...
                                        <>
                                            ...
                                            <li>
                                                <input 
                                                    ...
                                                    ref={userNameRef} 
                                                />
                                                {userName!=='' && <a onClick={(e)=>onClickIconDel(e, 'userName')} href="!#"><img src="./images/sub/sign_in/icon_del.svg" alt="" /></a>}
                                            </li>
                                        ...
                                        <>
                                            ...
                                            <li>
                                                <input 
                                                    ...
                                                    ref={userName2Ref} 
                                                />
                                                {userName2!=='' && <a onClick={(e)=>onClickIconDel(e, 'userName2')}   href="!#"><img src="./images/sub/sign_in/icon_del.svg" alt="" /></a>}
                                            </li>
